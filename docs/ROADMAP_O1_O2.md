...
Order of execution now: S5 (sweep over `rna_units_v1`, report only reads with a block inside a unit, forecast-vs-observed per family) → S6 (chapter). S1–S3 done; S4 folded into S5.
