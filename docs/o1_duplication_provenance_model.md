...
4. **Build recent subfamilies** from repeated compatible block paths plus the existing DNA
   ...
   [`o1_duplication_provenance_model.md`](o1_duplication_provenance_model.md).
...
*Merged from `o1_duplication_provenance_model.md` on 2026-08-20. That document opened by calling
