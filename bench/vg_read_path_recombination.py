...
# drops asm20 copy-vector artifacts (an allele with ~0 read support, e.g. RABL2 col25) and singleton
# sequencing errors. supported(base) = read-count >= max(ALLELE_SUPPORT_ABS, ALLELE_SUPPORT_FRAC*cov).
