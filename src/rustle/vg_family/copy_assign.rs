...
pub struct AssignParams {
    ...
    /// evidence) instead of the column-count score; twins fall through to the score. **Default `true` since
    /// 2026-09-09 (user, §6hk)**; the bin's `--no-best-by-duel` restores the score.
