...
pub mod terminal_oracle;  // RUSTLE_TERMINAL_ORACLE: inject ST terminal edges (analysis-only, default OFF)
...
pub mod psv_fasta; // opt-in PSV-FASTA emission (RUSTLE_VG_PSV_FASTA): transcript seqs + PSV report
